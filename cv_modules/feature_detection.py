            ...
            try:
                if method == "Harris Corner Detection":
                    ...
                    with col3:
                        ...
                        st.image(result_image, caption="Harris Corners", use_container_width=True)
                    ...
                    with col2:
                        ...
                        st.image(result_image, caption=f"{feature_type} Keypoints", use_container_width=True)
                    ...
                    with col2:
                        ...
                        st.image(result_image, caption="FAST Keypoints", use_container_width=True)
                    ...
                    with col2:
                        ...
                        st.image(thresh, caption="Binary Image", use_container_width=True, clamp=True)
                    
                    with col3:
                        st.subheader("Contours")
                        st.image(result_image, caption="Detected Contours", use_container_width=True)
